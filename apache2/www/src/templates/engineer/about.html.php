...
<p>
  For more about me, check out <a href="/linkedin" target="_blank">my LinkedIn profile</a> <?=includeIcon('box-arrow-up-right')?>, where you'll find all of the main highlights of my career so far.
</p>
<blockquote class="blockquote pt-3">
<p class="blockquote-footer">Ramsey El-Naggar, <?=date('F')?> <?=date('Y')?></p>
</blockquote>

<!-- <p>For the very few who might be interested, here's a superfluously detailed and completely undeserved biography.</p> -->
