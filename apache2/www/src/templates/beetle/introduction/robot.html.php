...
<p>
  ...
  That's why he has a built-in digital camera set to gaze up into the heavens, with a fish-eye lens allowing him to perceive light from across a large chunk of the sky simultaneously.
  He's also equipped with a custom-built array of four light sensors, each filtered at a different angle of polarisation.
  Together, these enable him to calculate the angle of polarisation of the light coming from the sky, just like his dung beetle brethren.
</p>
...
<p>
  By the way, if all this polarisation nonesense has you scratching your head, here's the 101.
  Polarised light is light that oscillates in a specific direction.
  This direction is different depending on where you look in the sky, and the pattern across the sky changes based on the sun's position.
  Nevertheless, if you're looking straight up from a fixed ground position, the angle of polarisation remains stable enough for navigation.
  Like the North Star for humans, polarisation helps lost dung beetle souls find their path through the wilderness.
  But wait!
  Before you run outside and peer at the sky in vain, you should know that humans can't tell the difference between polarised and unpolarised light.
  But guess who can?
...
<p>
  ...
  A polarising filter covers the entire setup, permitting only the light polarised in a specific direction to pass through.
  As each sensor has its own mini-filter set at a different angle, varying light quantities reach each one.
  These four data points together empower Pooptimus to calculate the sky's polarisation angle at any moment.
