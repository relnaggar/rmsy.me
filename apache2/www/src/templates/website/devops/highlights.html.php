<ul>
  ...
  <li>
    Integrated multiple <a href="#testing">testing</a> frameworks into the development environment, including a Selenium container with automated screen-recorded browser testing, all whilst keeping the production environment lightweight.
  </li>
</ul>