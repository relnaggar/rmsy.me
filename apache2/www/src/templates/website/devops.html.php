...
<ul>
  ...
  <li>Organised the application into standalone Docker containers.</li>
  <li>Configured the containers to work together.</li>
  <li>Wrote Bash scripts to automate development, testing, staging and deployment as far as possible.</li>
  <li>Created and configured a database service for the application.</li>
