...
<p>
  ...
  Grab this super flexible and friendly-as-a-golden-retriever framework, specifically <code><a href="<?=$publicUrl?>index.php" target="_blank">index.php</a></code> <?=includeIcon('box-arrow-up-right')?> and the <code><a href="<?=$frameworkUrl?>" target="_blank">Framework</a></code> <?=includeIcon('box-arrow-up-right')?> directory, insert your application's namespace and voila!
  You're set.
