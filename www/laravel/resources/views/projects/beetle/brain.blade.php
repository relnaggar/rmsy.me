...
<figure class="figure m-3 text-center col-lg-5 float-start col-12">
  <img
    src="{{ media('img/beetle/cx-full.png') }}"
...
<p>
  ...
  <x-external-link href="https://www.sciencedirect.com/science/article/pii/S0960982217310904">CX model of path integration in bees</x-external-link>
